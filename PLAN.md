...
- [x] **5. Grabar Video de Demostración (Bonus):**
  ...
  - [x] Subir el video a una plataforma pública (ej. YouTube, Google Cloud Storage, etc.).

- [x] **6. Revisión Final:**
  - [x] Limpiar el código y añadir comentarios donde sea necesario.
  - [x] Actualizar `requirements.txt` si hay nuevas dependencias.
  - [x] Realizar un commit final y preparar el repositorio para la entrega.